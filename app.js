...
function calPrice()
{
    const PhoneTotal = getquantity("Iphone_Quantity")*1219;
    const CaseTotal = getquantity("Case_Quantity")*59;
...
document.getElementById("plus_phone").addEventListener('click',function(){
    ...
    incdec(true,1219,"Iphone_Quantity","phone_price");
